...
| OPS-2 | **CRITICAL** | **`.env.v2.example` contains real security codes** -- L1=7951, L2=1522, L3=6130, L4=Caonima123! (should be placeholders). If committed to git, codes are permanently exposed in history. |
