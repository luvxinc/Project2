# backend/apps/inventory/views/__init__.py
"""
库存板块视图包
"""
    ...
    hub_items = [
        {
            ...
            'desc': _('查看各 SKU 的实时库存、下订、在途状态。'),
            'url': '/dashboard/inventory/dynamic_inv/',
            'has_access': True  # 查看功能默认开放
        },
        {
            'id': 'shelf',
            'name': _('仓库货架码'),
            'icon': 'fas fa-warehouse',
            'desc': _('管理仓库库位结构，查看货架地图，生成库位码。'),
            'url': '/dashboard/inventory/shelf/',
            'has_access': True  # 查看功能默认开放
        },
        {
            'id': 'upload',
