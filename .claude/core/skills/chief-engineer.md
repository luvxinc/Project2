...
> 🧠 **THINK (rules/common.md §12)**: 分解前必须推理 — 需求清晰吗? 依赖关系? 域边界? 哪些假设需验证?
> 📦 **Token-Efficient (rules/common.md §13)**: 批量操作用脚本编排, >100 行工具输出用脚本预处理后返回摘要。
...
> 🧠 **THINK (rules/common.md §12)**: 判定前必须推理 — 证据充分吗? 遗漏的维度? 置信度 >80%?
