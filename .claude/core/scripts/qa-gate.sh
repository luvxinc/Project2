...
if [ -x "/Users/aaron/Developer/MGMTV2/.claude/core/scripts/security-extra-audit.sh" ]; then
  ...
  if run_safe "$QA_TIMEOUT_SECURITY" "$QA_IDLE_SECURITY" env \
      ...
      /Users/aaron/Developer/MGMTV2/.claude/core/scripts/security-extra-audit.sh . "$QA_SECURITY_MODE"; then
...
QA_PROJECT_ROOT="${QA_PROJECT_ROOT:-/Users/aaron/Developer/MGMTV2/.claude/projects/mgmt}"
QA_SCOPE_ALLOWLIST_FILE="${QA_SCOPE_ALLOWLIST_FILE:-/Users/aaron/Developer/MGMTV2/.claude/core/reference/scope-allowlist.example.txt}"
...
if [ -n "${QA_SCOPE_CONTRACT_FILE:-}" ] && [ -x "/Users/aaron/Developer/MGMTV2/.claude/core/scripts/scope-contract-audit.sh" ]; then
  run_governance "Scope contract audit" /Users/aaron/Developer/MGMTV2/.claude/core/scripts/scope-contract-audit.sh "$QA_SCOPE_CONTRACT_FILE"
elif [ -x "/Users/aaron/Developer/MGMTV2/.claude/core/scripts/scope-audit.sh" ]; then
  run_governance "Scope audit" /Users/aaron/Developer/MGMTV2/.claude/core/scripts/scope-audit.sh "$QA_SCOPE_ALLOWLIST_FILE" "${QA_SCOPE_BASE_REF:-HEAD~1}"
else
  if [ "$QA_GOVERNANCE_MODE" = "enforce" ]; then
...
if [ -x "/Users/aaron/Developer/MGMTV2/.claude/core/scripts/acceptance-audit.sh" ]; then
  if [ -n "$QA_ACCEPTANCE_MATRIX_FILE" ] && [ -f "$QA_ACCEPTANCE_MATRIX_FILE" ]; then
    run_governance "Acceptance audit" /Users/aaron/Developer/MGMTV2/.claude/core/scripts/acceptance-audit.sh "$QA_ACCEPTANCE_MATRIX_FILE"
  else
    if [ "$QA_GOVERNANCE_MODE" = "enforce" ]; then
...
if [ -x "/Users/aaron/Developer/MGMTV2/.claude/core/scripts/no-guess-audit.sh" ]; then
  if [ -n "$QA_REPORT_FILE" ] && [ -f "$QA_REPORT_FILE" ]; then
    run_governance "No-guess audit" /Users/aaron/Developer/MGMTV2/.claude/core/scripts/no-guess-audit.sh "$QA_REPORT_FILE"
  else
    if [ "$QA_GOVERNANCE_MODE" = "enforce" ]; then
...
if [ -x "/Users/aaron/Developer/MGMTV2/.claude/core/scripts/delivery-gate-format-audit.sh" ] && [ -n "$QA_REPORT_FILE" ] && [ -f "$QA_REPORT_FILE" ]; then
  run_governance "Delivery gate format audit" /Users/aaron/Developer/MGMTV2/.claude/core/scripts/delivery-gate-format-audit.sh "$QA_REPORT_FILE"
fi

# role output format audits (optional via explicit files)
if [ -n "${QA_CTO_REPORT_FILE:-}" ] && [ -x "/Users/aaron/Developer/MGMTV2/.claude/core/scripts/cto-format-audit.sh" ]; then
  run_governance "CTO format audit" /Users/aaron/Developer/MGMTV2/.claude/core/scripts/cto-format-audit.sh "$QA_CTO_REPORT_FILE"
fi
if [ -n "${QA_ENGINEER_REPORT_FILE:-}" ] && [ -x "/Users/aaron/Developer/MGMTV2/.claude/core/scripts/engineer-format-audit.sh" ]; then
  run_governance "Engineer format audit" /Users/aaron/Developer/MGMTV2/.claude/core/scripts/engineer-format-audit.sh "$QA_ENGINEER_REPORT_FILE"
fi
if [ -n "${QA_QA_REPORT_FILE:-}" ] && [ -x "/Users/aaron/Developer/MGMTV2/.claude/core/scripts/qa-format-audit.sh" ]; then
  run_governance "QA format audit" /Users/aaron/Developer/MGMTV2/.claude/core/scripts/qa-format-audit.sh "$QA_QA_REPORT_FILE"
fi
if [ -n "${QA_GUARD_REPORT_FILE:-}" ] && [ -x "/Users/aaron/Developer/MGMTV2/.claude/core/scripts/guard-format-audit.sh" ]; then
  run_governance "Guard format audit" /Users/aaron/Developer/MGMTV2/.claude/core/scripts/guard-format-audit.sh "$QA_GUARD_REPORT_FILE"
fi
if [ -n "${QA_SHIP_REPORT_FILE:-}" ] && [ -x "/Users/aaron/Developer/MGMTV2/.claude/core/scripts/ship-format-audit.sh" ]; then
  run_governance "Ship format audit" /Users/aaron/Developer/MGMTV2/.claude/core/scripts/ship-format-audit.sh "$QA_SHIP_REPORT_FILE"
fi
if [ -n "${QA_LEARN_REPORT_FILE:-}" ] && [ -x "/Users/aaron/Developer/MGMTV2/.claude/core/scripts/learn-format-audit.sh" ]; then
  run_governance "Learn format audit" /Users/aaron/Developer/MGMTV2/.claude/core/scripts/learn-format-audit.sh "$QA_LEARN_REPORT_FILE"
fi
