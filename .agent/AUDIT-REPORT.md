...
> **审计日期**: 2026-02-19
> **审计范围**: `.agent/` 全目录 — Skills, Workflows, Rules, Templates, Memory, Warehouse
...
多个文件中存在 `.agent/.agent/projects/` 的双层路径错误:

| 文件 | 行号 | 错误路径 |
|------|------|---------|
| `core/skills/chief-engineer.md` | L203 | `.agent/.agent/projects/{project}/data/progress/engineering-status.md` |
| `core/skills/project-manager.md` | L243 | `.agent/.agent/projects/{project}/data/progress/user-feedback.md` |
| `core/skills/project-manager.md` | L276 | `.agent/.agent/projects/{project}/data/progress/requirements-list.md` |
| `core/skills/project-manager.md` | L308 | `.agent/.agent/projects/{project}/data/progress/risk-register.md` |
| `core/skills/qa-auditor.md` | L366 | `.agent/.agent/projects/{project}/data/training/...` |
| `core/skills/qa-auditor.md` | L376 | `.agent/.agent/projects/{project}/data/errors/` |
| `core/skills/requirements.md` | L155 | `.agent/.agent/projects/{project}/data/specs/...` |
