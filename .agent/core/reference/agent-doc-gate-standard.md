...
```bash
/Users/aaron/Developer/MGMTV2/.agent/core/scripts/agent-doc-audit.sh /Users/aaron/Developer/MGMTV2/.agent
```
...
```bash
bash .agent/core/scripts/agent-doc-audit.sh .agent | tee /tmp/agent-doc-audit.log
