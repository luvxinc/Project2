...
const vmaSubNav = [
  ...
  { key: 'training_sop', href: '/vma/training-sop', icon: 'training_sop' },
  { key: 'training_records', href: '/vma/training-records', icon: 'training_records' },
];
...
function NavIcon({ name }: { name: string }) {
  ...
  const icons: Record<string, React.ReactNode> = {
    ...
    training_records: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.8}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15a2.25 2.25 0 012.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m8.9827 3.97l-4.244 4.243a1.125 1.125 0 01-.476.262l-2.285.571.571-2.285a1.125 1.125 0 01.262-.476l4.243-4.243a1.5 1.5 0 012.122 0l.293.293a1.5 1.5 0 010 2.122l-.172.171z" />
      </svg>
    ),
  };
